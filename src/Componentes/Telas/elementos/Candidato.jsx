...
export default function Candidato(props) {
    ...
    function curtidaEDescurtida(opc){
        if(opc === true){
            ...
            props.candidato.descurtidas = descurtidas
            setDescurtidas(novasDescurtidas)
        }
    ...
    return (
        <Card style={{ width: '18rem' }}>
            ...
            <Card.Body>
                ...
                <Button variant="primary"onClick={()=>curtidaEDescurtida(true)}> {//Curtir
                                           }
                ...
                </Button> <Button variant="primary"onClick={()=>curtidaEDescurtida(false)}> {//Não Curtir
                                           }
                ...
                <Button className="mt-1" variant="success" onClick={()=>{setProposta(!proposta)}}>
                    Conheça minhas propostas</Button>
                    {proposta && (
                    <>
                        {props.candidato.propostas.map((proposta)=>{
                            return <p>- {proposta}</p>})}
                    </> )}
            </Card.Body>
        </Card>
